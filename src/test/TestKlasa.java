...
public class TestKlasa {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println("---------- Pregedi nakon izmene ------------");
		preg.ucitajPreglede();
		...
		doca.ucitajLekare();
		ArrayList<Lekar> lekariPosleBrisanja = doca.dajSveLekareSaPregledima();
		...
		pac.ucitajPacijente();
		ArrayList<Pacijent> pacijentiPosleBrisanja = pac.dajSvePacijenteSaPregledima();
